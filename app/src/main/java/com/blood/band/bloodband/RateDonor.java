...
public class RateDonor extends AppCompatActivity {
    String rate = "0", dn_date = "", bg = "", userid="", username, f3, f4, f5, f6, f7, f8, r1, r2, r3, r4, r5, id, res;
    ...
    private EditText inputName, inputEmail, inputAddress, inputPhone, inputRel;
    private TextInputLayout inputLayoutName, inputLayoutEmail, inputLayoutPhone, inputLayoutRel, inputLayoutAddress;
    Button submit;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.rate_donor);
        ...
        TextView login = (TextView) findViewById(R.id.dologin);
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getBaseContext(), LoginRating.class);
        ...
        inputLayoutRel = (TextInputLayout) findViewById(R.id.input_relation);
        inputLayoutEmail = (TextInputLayout) findViewById(R.id.input_email);
        inputLayoutPhone = (TextInputLayout) findViewById(R.id.input_phone);

        inputName = (EditText) findViewById(R.id.sign_name);
        inputAddress = (EditText) findViewById(R.id.sign_address);
        inputRel = (EditText) findViewById(R.id.sign_relation);
        inputEmail = (EditText) findViewById(R.id.sign_email);
        inputPhone = (EditText) findViewById(R.id.sign_phone);
        ...
        name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                attendance.showdialog(RateDonor.this, "");
            }
        });
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(RateDonor.this, R.style.DialogTheme,
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(RateDonor.this);
    ...
    public class Donor {
        ...
        public void showdialog(AppCompatActivity activity, String title) {
            ...
            group.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    LayoutInflater inflater = RateDonor.this.getLayoutInflater();
                    final android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(RateDonor.this);
            ...
            if (bg.equals("1")) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        new ReadJSON().execute("http://www.bloodband.dhost247.net/direct/fghjfghvigdfghdfgsrtweritadfas_asdfasdfasdfrepasdfasdfasdfortdfasdfasdf/923hd?blood_group=" + bg + "&district_id=&upazila_id=");
            ...
            gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    if(id.equals(userid)){
                        Toast.makeText(RateDonor.this, "নিজের মূল্যায়ন করতে পারবেন না", Toast.LENGTH_SHORT).show();
                    }else{
    ...
    class ReadJSON extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String content) {
            ...
            CustomListAdapterDonor adapter = new CustomListAdapterDonor(
                    getApplicationContext(), R.layout.user_list_item, arrayList
            );
            ...
            Animation animation = AnimationUtils.loadAnimation(RateDonor.this,
                    R.anim.alpha1);
    ...
    public void submitResult() {
        ...
        String rel = inputRel.getText().toString();
