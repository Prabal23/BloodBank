 ...
 */
public class CustomListAdapterCache extends ArrayAdapter<ProductCache> {

    ArrayList<ProductCache> products;
    Context context;
    int resource;
    Typeface fontAwesomeFont;

    public CustomListAdapterCache(Context context, int resource, ArrayList<ProductCache> products) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ProductCache product = getItem(position);
