    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!validatePass()) {
                            ...
                            new Response.Listener<String>() {
                                ...
                                public void onResponse(String response) {
                                    ...
                                    if (except_double.contains("failed") || except_double.contains("fails")) {
                                        Toast.makeText(LoginRequest.this, "ইউজারনেম/পাসওয়ার্ড সঠিক হয়নি", Toast.LENGTH_LONG).show();
                                    } else {
                                        //Creating a shared preference
                                        SharedPreferences sharedPreferences = LoginRequest.this.getSharedPreferences(Links.SHARED_PREF_NAME, Context.MODE_PRIVATE);
                                        ...
                                        Intent intent = new Intent(LoginRequest.this, RequestbyMe.class);
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(LoginRequest.this);
        ...
        forgotpass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alert1.showDialog(LoginRequest.this, "পাসওয়ার্ড পুনরুদ্ধার করুন");
            }
        });
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(LoginRequest.this);
        ...
        public void showDialog(AppCompatActivity activity, String msg) {
            ...
            submit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(user.equals("")){
                        Toast.makeText(LoginRequest.this, "অনুগ্রহ করে আপনার ব্যবাহার্য নামটি লিখুন", Toast.LENGTH_SHORT).show();
                    }
                    if(user.contains(" ")){
                    ...
                    if(pass.equals("")){
                        Toast.makeText(LoginRequest.this, "অনুগ্রহ করে আপনার পাসওয়ার্ডটি লিখুন", Toast.LENGTH_SHORT).show();
                    }
                    if(pass.contains(" ")){
                    ...
                    try {
                        ...
                        if (res.contains("User Name Not Matched")) {
                            Toast.makeText(LoginRequest.this, "ইউজারনেম মিলেনি!", Toast.LENGTH_LONG).show();
                        } else {
